...
| `Change Shorts repeat state` | Adds an option to control whether Shorts should repeat, autoplay, or pause upon ending. | 18.29.38 ~ 19.16.39 |
...
| `Enable OPUS codec` | Adds an option to use the OPUS audio codec instead of the MP4A audio codec. | 6.29.58 ~ 7.10.51 |
...
| `Translations` | Adds Crowdin translations for YouTube Music. | 6.29.58 ~ 7.10.51 |
...
| `Visual preferences icons` | Adds icons to specific preferences in the settings. | 6.29.58 ~ 7.10.51 |
</details>
